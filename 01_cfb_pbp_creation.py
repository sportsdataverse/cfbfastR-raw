...
def main():
    ...
    for year in years_arr:
        ...
        if path_to_schedules is not None:
            ...
            season_schedule.to_csv(f"{path_to_schedules}/csv/cfb_schedules_{year}.csv", index = False)
            season_schedule.to_parquet(f"{path_to_schedules}/parquet/cfb_schedules_{year}.parquet", index = False)
            pyreadr.write_rds(f"{path_to_schedules}/rds/cfb_schedules_{year}.rds", season_schedule)
            fp = f"{path_to_schedules}/json/cfb_schedules_{year}.json"
            with open(fp,'w') as f:
